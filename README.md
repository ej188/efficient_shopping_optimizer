...
![Bar chart showing item category breakdown](figures/item_category_breakdown.png)
*Figure 1. Distribution of selected items by category*

![Bar chart showing protein per dollar for selected items](figures/protein_per_dollar.png)
*Figure 2. Protein contribution per dollar for each selected item*
